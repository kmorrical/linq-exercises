    ...
    public class SuppliersController : ApiController
    {
        ...
        public IHttpActionResult GetSalesAndMarketing()
        {
            ...
            var resultSet = _db.Suppliers
                                         .Where(c => c.ContactTitle == "Marketing Manager" || c.ContactTitle == "Sales Representative")
                                         .Where(c => c.Fax.Length > 0);
            return Ok(resultSet);
        }
        ...
        {
            //throw new NotImplementedException("Write a query to return all Suppliers containing the 'term' 
               // variable in their address.
