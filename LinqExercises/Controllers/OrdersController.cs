...
namespace LinqExercises.Controllers
{
    public class OrdersController : ApiController
    {
        ...
        {
            //throw new NotImplementedException("Write a query to return all orders with 
            //required dates between the given start date and the given end date with freight under 100 units.");
            var resultSet = _db.Orders.Where(c => c.RequiredDate<=endDate && c.RequiredDate>=startDate && c.Freight<100);
            return Ok(resultSet);
        }
        ...
        public IHttpActionResult PurchaseReport()
        {
         ...
         //  ");
            //var resultSet = _db.[Order Details].Select(o => new
            // {
            //  ProductID = o.OrderID,
            // Quantity = o.Quantity
            // }
