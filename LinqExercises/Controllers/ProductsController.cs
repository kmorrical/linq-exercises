...
namespace LinqExercises.Controllers
{
    public class ProductsController : ApiController
    {
        ...
        public IHttpActionResult GetDiscontinuedCount()
        {
            ...
            var resultSet = _db.Products.Where(c => c.Discontinued==true).Count();
            return Ok(resultSet);
        }
        ...
        public IHttpActionResult GetStockReport()
        {
            ...
            var resultSet = _db.Products.Select(p => new
            {
                ...
                TotalStockUnits = (p.UnitsInStock + p.UnitsOnOrder)
                                    ...
                                    .Where(od => od.TotalStockUnits > 100);
        //I know how to do sum of whole column but what about not whole column, just two cells in a row?
        //Do we need to take the .Where out of the brackets/parentheses?
